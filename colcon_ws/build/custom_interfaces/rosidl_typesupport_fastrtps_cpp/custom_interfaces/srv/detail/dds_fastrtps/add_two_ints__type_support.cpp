...
#include "custom_interfaces/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const custom_interfaces::msg::Num &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_interfaces::msg::Num &);
...
// functions for custom_interfaces::msg::Num already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: a
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Num(
...
{
  // Member: a
  custom_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.a,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: a
  current_alignment +=
    custom_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.a, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Member: a
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Num(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, AddTwoInts_Request)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, AddTwoInts_Response)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
// functions for custom_interfaces::srv::AddTwoInts_Request already declared above

// functions for custom_interfaces::srv::AddTwoInts_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::srv::AddTwoInts_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::srv::AddTwoInts_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_AddTwoInts_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_AddTwoInts_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces::srv::AddTwoInts_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_AddTwoInts_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_AddTwoInts_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::AddTwoInts_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::AddTwoInts_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_AddTwoInts_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, AddTwoInts_Event)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_AddTwoInts_Event__handle;
}
...
static const rosidl_service_type_support_t _AddTwoInts__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_interfaces::srv::AddTwoInts_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_interfaces::srv::AddTwoInts_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_interfaces::srv::AddTwoInts_Event>(),
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, AddTwoInts)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
