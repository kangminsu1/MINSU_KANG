...
: ${AMENT_CURRENT_PREFIX:="/home/user05/colcon_ws/install/srvmsg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/srvmsg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/srvmsg/environment/path.sh"
